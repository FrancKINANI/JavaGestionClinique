...
('2023-12-01 09:00:00', '2023-12-01 09:30:00', 'DISPONIBLE'), -- id=1
('2023-12-01 10:00:00', '2023-12-01 10:30:00', 'DISPONIBLE'), -- id=2
('2023-12-01 11:00:00', '2023-12-01 11:30:00', 'DISPONIBLE'), -- id=3
('2023-12-01 14:00:00', '2023-12-01 14:30:00', 'DISPONIBLE'), -- id=4
('2023-12-01 15:00:00', '2023-12-01 15:30:00', 'DISPONIBLE'), -- id=5
('2023-12-02 09:00:00', '2023-12-02 09:30:00', 'RESERVE'),    -- id=6
('2023-12-02 10:00:00', '2023-12-02 10:30:00', 'RESERVE');    -- id=7

-- Rendez-vous à venir
INSERT INTO rendez_vous (date_creation, statut, commentaire, duree, patient_id, time_slot_id, salle_id, scheduler_id, docteur_id)
VALUES
  (NOW(), 'PLANIFIE', 'Première consultation cardiologie', 30, 1, 1, 1, 6, 4),
  (NOW(), 'CONFIRME', 'Suivi dermatologique', 30, 2, 2, 3, 6, 5);

-- Rendez-vous passés  
INSERT INTO rendez_vous (date_creation, statut, commentaire, duree, patient_id, time_slot_id, salle_id, scheduler_id, docteur_id)
VALUES
  ('2023-11-15 10:00:00', 'TERMINE', 'Contrôle annuel', 30, 3, 3, 2, 6, 5),
  ('2023-11-20 14:30:00', 'TERMINE', 'Examen de routine', 30, 1, 4, 1, 6, 4);

-- Rendez-vous annulés
INSERT INTO rendez_vous (date_creation, statut, commentaire, duree, patient_id, time_slot_id, salle_id, scheduler_id, docteur_id)
VALUES
  ('2023-11-10 11:00:00', 'ANNULE', 'Patient a reporté', 30, 2, 5, NULL, 6, 4),
  ('2023-11-12 15:00:00', 'ANNULE', 'Patient a annulé', 30, 3, 6, NULL, 6, 4);

-- Rendez-vous reportés
INSERT INTO rendez_vous (date_creation, statut, commentaire, duree, patient_id, time_slot_id, salle_id, scheduler_id, docteur_id)
VALUES
  ('2023-11-18 10:00:00', 'REPORTE', 'Patient a demandé un report', 30, 1, 7, NULL, 6, 4);

-- Rendez-vous confirmés
INSERT INTO rendez_vous (date_creation, statut, commentaire, duree, patient_id, time_slot_id, salle_id, scheduler_id, docteur_id)
VALUES
  ('2023-11-28 10:00:00', 'CONFIRME', 'Consultation confirmée', 30, 2, 1, NULL, 6, 4),
  ('2023-11-29 14:30:00', 'CONFIRME', 'Consultation confirmée', 30, 3, 2, NULL, 6, 4);

-- Rendez-vous planifiés
INSERT INTO rendez_vous (date_creation, statut, commentaire, duree, patient_id, time_slot_id, salle_id, scheduler_id, docteur_id)
VALUES
  ('2023-11-30 10:00:00', 'PLANIFIE', 'Consultation planifiée', 30, 1, 3, NULL, 6, 4),
  ('2023-12-01 14:30:00', 'PLANIFIE', 'Consultation planifiée', 30, 2, 4, NULL, 6, 4);
